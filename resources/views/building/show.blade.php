...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h1 class="dashboard-title">{{ $building->name }} Flats</h1>
        <a href="{{ route('flats.create', $building->id) }}" class="btn btn-primary add-flat-btn">+ New Flat</a>
    </div>
    <div class="buildings-grid">
        @foreach ($flats as $flat)
        <div class="building-box-container" style="position: relative;">
            <a href="{{ route('flats.show', $flat->id) }}" class="building-box">
                <h4>{{ $flat->name }}</h4>
                <p>Total Payment Due:</p>
                <p>${{ number_format($flat->total_payment_due, 2) }}</p>
            </a>
            ...
            <div class="dropdown more-options">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('flats.edit', $flat->id) }}">Edit</a>
